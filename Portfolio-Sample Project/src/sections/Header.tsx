  ...
  return <header className="fixed top-0 left-0 w-full backdrop-blur-md">
    <div className="container !max-w-full">
      <div className="flex justify-between h-20 items-center">
        ...
        <div className="flex items-center gap-4 max-md:pr-2">
          <div className="size-11 border border-stone-400 bg-stone-200 rounded-full flex items-center justify-center">
